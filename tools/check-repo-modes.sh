...
tools/install-on-player.sh tools/install-hooks.sh tools/check-repo-modes.sh tools/deploy-to-player.sh tools/reference-check.mjs tools/check-commit-reference.mjs"
